...
namespace App\Containers\UserSection\Authentication\Classes;
...
class LoginCustomAttribute
{
    ...
    {
        $prefix = config('userSection-authentication.login.prefix', '');
    ...
    {
        $allowedLoginFields = config('userSection-authentication.login.attributes');
    ...
    {
        return config('userSection-authentication.login.case_sensitive') ? $username : strtolower($username);
    }
