    ...
    */
    ...
    'login' => [
        ...
        */
        ...
        | If falogin-page-urllse, then user can log in with both `admin@admin.com` and `Admin@Admin.Com`
        |
        */
...
//        env('APP_URL', 'http://api.apiato.test/api/v1') . '/password/reset',
//        'http://127.0.0.1:8000/api/v1/password/reset',
        env('APP_URL').'/password/reset/form',
//
    ],
