...
namespace App\Containers\UserSection\Authentication\UI\API\Tests;
...
class ApiTestCase extends ParentTestCase
{
    ...
    protected function setUp(): void
    {
        ...
        Config::set('userSection-authentication.clients.web.id', $clientId);
        Config::set('userSection-authentication.clients.web.secret', $clientSecret);
