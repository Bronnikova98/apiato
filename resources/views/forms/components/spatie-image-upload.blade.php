...
<style>
    .{{ $getWrapperClass() }} .filepond--list {
        display: flex;
    }

    .{{ $getWrapperClass() }} .filepond--item {
        margin: 2px !important;
        width: calc({{ $getInlineItemWidth() }} - 4px);
    }
</style>
...
>
    <div
        ...
        {{ $attributes->merge($getExtraAttributes())->class(['filament-forms-file-upload-component ' . $getWrapperClass(), 'w-32 mx-auto' => $isAvatar()]) }}
